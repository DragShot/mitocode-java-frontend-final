...
@NgModule({
  ...
  entryComponents: [MedicoDialogoComponent, DialogoComponentComponent, PacienteModalComponent],
  imports: [
    BrowserModule,
    AppRoutingModule,
    ...
    JwtModule.forRoot({
      config: {
        ...
        whitelistedDomains: ['192.168.0.*', 'localhost', 'ds-serv.tk', 'dscore.webcindario.com', 'dshst.webcindario.com'],
